...
export const OrdersCard = ({ totalPrice, totalProducts, orderDate }) => {
    ...
    return (
        <div className='flex justify-between items-center gap-5 mb-3 shadow-md rounded-lg p-3'>
            ...
            <div className='flex gap-1 items-center justify-center'>
                ...
                <p className='text-sm font-light'>{totalProducts}</p>
            </div>
            <div className="flex gap-1 items-center justify-center">
